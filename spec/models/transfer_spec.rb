...
describe Transfer do
  ...
  let!(:transfer_item_player) { TransferItem.create( id: 1, transfer: transfer, transfer_item_type: "Player", team_player: team_player, sending_team: team_1, receiving_team: team_2 ) }

  let!(:transfer_item_cash) { TransferItem.create( id: 2, transfer: transfer, transfer_item_type: "Cash", cash_cents: 100000000, sending_team: team_2, receiving_team: team_1 ) }
