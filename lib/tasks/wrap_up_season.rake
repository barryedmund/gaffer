      ...
      ['Goalkeeper', 'Defender', 'Midfielder', 'Forward'].each do |position|
        ...
        if position == "Goalkeeper"
          { :most_valuable_goalkeeper => [most_valuable_at_position_team, most_valuable_at_position.full_name],
            ...
            :highest_paid_goalkeeper => [highest_paid_team_player.team, "#{highest_paid_team_player.full_name}, #{highest_paid_team_player.current_contract.weekly_salary_cents}"],
          ...
          { :most_valuable_defender => [most_valuable_at_position_team, most_valuable_at_position.full_name],
            ...
            :highest_paid_defender => [highest_paid_team_player.team, "#{highest_paid_team_player.full_name}, #{highest_paid_team_player.current_contract.weekly_salary_cents}"],
          ...
          { :most_valuable_midfielder => [most_valuable_at_position_team, most_valuable_at_position.full_name],
            ...
            :highest_paid_midfielder => [highest_paid_team_player.team, "#{highest_paid_team_player.full_name}, #{highest_paid_team_player.current_contract.weekly_salary_cents}"],
          ...
          { :most_valuable_forward => [most_valuable_at_position_team, most_valuable_at_position.full_name],
            ...
            :highest_paid_forward => [highest_paid_team_player.team, "#{highest_paid_team_player.full_name}, #{highest_paid_team_player.current_contract.weekly_salary_cents}"],
